window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#region lib/types/client/catch-design.js
		const REWARDS = [
			{
				kind: "star",
				speed: 28,
		...
		//#endregion
		//#region lib/types/client/catch-physics.js
		...
		//#endregion
		//#region lib/types/client/jump-design.js
		...
		//#endregion
		//#region lib/types/client/jump-physics.js
		...
		//#endregion
		//#region lib/types/client/leaderboard.js
		const KEY = "dsh.whale-arcade.scores.v1";
		/** Read the ten highest scores for one game. */
		function readScores(game) {
			try {
				return JSON.parse(localStorage.getItem(KEY) ?? "{}")[game]?.filter((entry) => Number.isFinite(entry.score) && Number.isFinite(entry.durationMs)) ?? [];
			} catch {
				return [];
			}
		}
		...
		function recordScore(game, entry) {
			...
			const table = [...all[game] ?? [], entry].sort((a, b) => b.score - a.score || a.durationMs - b.durationMs || a.achievedAt - b.achievedAt).slice(0, 10);
			all[game] = table;
			localStorage.setItem(KEY, JSON.stringify(all));
			return table;
		}
		//#endregion
		//#region lib/types/client/runner-design.js
		const GAP_WEIGHTS = [
			{
				value: "short",
				weight: .3
		...
		//#endregion
		//#region lib/types/client/runner-physics.js
		/**
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/home/jtf/projects/learning/deepseek-harness/packages/client/ui-whale-arcade/src/client/WhaleArcade.module.css.mjs
		const css = "._2SxacG_root{color:var(--dsw-alias-label-primary);font:var(--dsw-font-s-14);flex-direction:column;align-items:flex-end;gap:12px;display:flex;position:absolute;bottom:22px;right:24px}._2SxacG_launcher{width:58px;height:48px;color:var(--dsw-alias-state-business-primary);filter:drop-shadow(0 5px 5px var(--dsw-alias-interactive-bg-active));cursor:pointer;transition:transform var(--ds-transition-duration-slow) var(--ds-ease-in-out);background:0 0;border:0;padding:0;animation:4.6s ease-in-out infinite _2SxacG_whaleFloat;position:relative}._2SxacG_launcher:hover{transform:translateY(-4px)scale(1.06)}._2SxacG_launcher svg{z-index:1;width:100%;height:100%;position:relative}._2SxacG_whaleBody{fill:var(--dsw-alias-state-business-primary)}._2SxacG_whaleBelly{fill:var(--dsw-alias-bg-layer-2);opacity:.92}._2SxacG_whaleTail{fill:var(--dsw-alias-state-business-primary)}._2SxacG_whaleEye{fill:var(--dsw-alias-label-primary-inverted)}._2SxacG_whaleSmile,._2SxacG_whaleSpout{fill:none;stroke:var(--dsw-alias-label-primary-inverted);stroke-width:2px;stroke-linecap:round}._2SxacG_whaleSpout{stroke:var(--dsw-alias-state-business-primary)}._2SxacG_panel{--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);box-sizing:border-box;border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-2);width:min(560px,100vw - 32px);max-height:min(700px,100vh - 100px);box-shadow:var(--dsw-shadow-lv3);border-radius:22px;padding:18px;overflow:auto}._2SxacG_panel[data-in-game]{padding:12px}._2SxacG_panel header,._2SxacG_gameTitle,._2SxacG_gameBar{justify-content:space-between;align-items:center;gap:12px;display:flex}._2SxacG_panel h2{font:var(--dsw-font-l-20);margin:0}._2SxacG_panel header p{color:var(--dsw-alias-label-secondary);margin:3px 0 0}._2SxacG_panel button{color:inherit;font:inherit}._2SxacG_iconButton{background:var(--dsw-alias-interactive-bg-hover);cursor:pointer;border:0;border-radius:50%;width:32px;height:32px;font-size:22px!important}._2SxacG_catalog{grid-template-columns:repeat(3,1fr);gap:10px;margin-top:18px;display:grid}._2SxacG_catalog>button{border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-bg-layer-1);cursor:pointer;border-radius:14px;flex-direction:column;align-items:center;gap:7px;min-width:0;padding:13px 8px;display:flex}._2SxacG_catalog>button:hover{background:var(--dsw-alias-interactive-bg-hover);border-color:var(--dsw-alias-border-l3);transform:translateY(-2px)}._2SxacG_catalog small{min-height:48px;color:var(--dsw-alias-label-secondary);line-height:16px}._2SxacG_catalog b{color:var(--dsw-alias-state-business-primary);font:var(--dsw-font-xxs-12)}._2SxacG_catalogIcon{width:50px;height:40px;color:var(--dsw-alias-state-business-primary);place-items:center;display:grid;position:relative}._2SxacG_catalogIcon svg{width:44px;height:36px}._2SxacG_catalogIcon ._2SxacG_miniWave{border-top:3px solid var(--dsw-alias-state-business-primary);opacity:.45;border-radius:50%;width:44px;height:7px;position:absolute;bottom:1px}._2SxacG_gameBar button,._2SxacG_gameOverlay button{background:var(--dsw-alias-interactive-bg-hover);cursor:pointer;border:0;border-radius:9px;padding:7px 11px}._2SxacG_gameBar button:not(:disabled):hover,._2SxacG_gameOverlay button:hover{color:var(--dsw-alias-state-business-primary);background:var(--dsw-alias-interactive-bg-hover-accent)}._2SxacG_game{background:var(--dsw-alias-bg-layer-2);border-radius:14px;position:relative;overflow:hidden}._2SxacG_gameBar{min-height:42px;color:var(--dsw-alias-label-secondary);white-space:nowrap;padding:0 2px 9px}._2SxacG_gameBar strong{color:var(--dsw-alias-label-primary)}._2SxacG_gameBar ._2SxacG_hint{text-overflow:ellipsis;flex:1;min-width:0;overflow:hidden}._2SxacG_backButton,._2SxacG_closeButton{width:32px;padding-inline:0!important;font-size:18px!important}._2SxacG_closeButton{border-radius:50%!important}._2SxacG_gameOverlay{color:var(--dsw-alias-label-secondary);background:var(--dsw-alias-bg-mask-drop);backdrop-filter:blur(2px);z-index:20;place-content:center;justify-items:center;gap:12px;display:grid;position:absolute;inset:51px 1px 1px}._2SxacG_oceanBoard{border:1px solid var(--dsw-alias-border-l2);cursor:pointer;background:linear-gradient(180deg, var(--dsw-alias-bg-layer-2), var(--dsw-alias-state-business-tertiary));border-radius:14px;outline:none;width:100%;height:300px;padding:0;display:block;position:relative;overflow:hidden}._2SxacG_oceanBoard:focus-visible{box-shadow:inset 0 0 0 2px var(--dsw-alias-state-business-primary)}._2SxacG_gameWhale,._2SxacG_catcher,._2SxacG_runnerWhale{width:50px;height:38px;color:var(--dsw-alias-state-business-primary);z-index:5;will-change:transform, top, left, bottom;position:absolute}._2SxacG_gameWhale{left:14%;transform:translateY(-50%)}._2SxacG_gameWhale svg,._2SxacG_catcher svg,._2SxacG_runnerWhale svg{width:100%;height:100%;filter:drop-shadow(0 5px 4px var(--dsw-alias-interactive-bg-active))}._2SxacG_jumpingWhale{transform:rotate(-8deg)}._2SxacG_catcher{bottom:30px;transform:translate(-50%)}._2SxacG_runnerWhale{width:52px;left:13%;transform:rotate(-3deg)}._2SxacG_rockGate{z-index:4;width:24px;position:absolute;top:0;bottom:0;transform:translate(-50%)}._2SxacG_rockGate i{background:var(--dsw-alias-border-l3);opacity:.48;width:32px;position:absolute;left:-4px}._2SxacG_rockGate i:after{content:\"\";border:3px solid var(--dsw-alias-state-error-secondary);opacity:.55;border-width:0 3px;border-radius:50%;width:18px;height:22px;position:absolute;left:7px}._2SxacG_rockGate i:first-child{clip-path:polygon(0 0,100% 0,78% 22%,91% 43%,70% 60%,100% 100%,0 100%,25% 63%,5% 42%,31% 22%);border-radius:0 0 48% 26%;top:0}._2SxacG_rockGate i:first-child:after{bottom:4px}._2SxacG_rockGate i:last-child{clip-path:polygon(0 0,100% 0,76% 32%,94% 49%,68% 66%,100% 100%,0 100%,29% 69%,5% 50%,27% 31%);border-radius:32% 42% 0 0;bottom:0}._2SxacG_rockGate i:last-child:after{top:5px}._2SxacG_oceanWaves{z-index:3;pointer-events:none;height:34px;position:absolute;bottom:-7px;left:-4%;right:-4%}._2SxacG_oceanWaves i{background:var(--dsw-alias-border-l3);opacity:.28;clip-path:polygon(0 42%,9% 25%,19% 44%,30% 31%,41% 48%,53% 28%,65% 45%,78% 26%,89% 43%,100% 29%,100% 100%,0 100%);position:absolute;inset:0}._2SxacG_oceanWaves i:last-child{opacity:.2;transform:translate(5%)}._2SxacG_skyBubbles i{border:2px solid var(--dsw-alias-state-business-primary);opacity:.18;border-radius:50%;animation:4s ease-in infinite _2SxacG_bubbles;position:absolute}._2SxacG_skyBubbles i:first-child{width:8px;height:8px;bottom:15%;left:35%}._2SxacG_skyBubbles i:nth-child(2){width:13px;height:13px;animation-delay:1.3s;bottom:4%;left:61%}._2SxacG_skyBubbles i:nth-child(3){width:6px;height:6px;animation-delay:2.1s;bottom:18%;left:83%}._2SxacG_lightRays{background:linear-gradient(112deg, transparent 18%, var(--dsw-alias-interactive-bg-hover) 20%, transparent 39%, var(--dsw-alias-interactive-bg-hover) 42%, transparent 65%);opacity:.55;position:absolute;inset:0}._2SxacG_falling{z-index:4;will-change:top;width:38px;height:38px;position:absolute;transform:translate(-50%,-50%)}._2SxacG_falling svg,._2SxacG_obstacle svg{width:100%;height:100%;overflow:visible}._2SxacG_itemValue{color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xxs-12);white-space:nowrap;position:absolute;top:-9px;left:50%;transform:translate(-50%)}._2SxacG_star{fill:var(--dsw-alias-state-warn-primary)}._2SxacG_objectDot{fill:var(--dsw-alias-label-primary)}._2SxacG_pearlShellBack{fill:var(--dsw-alias-state-warn-tertiary);stroke:var(--dsw-alias-state-warn-secondary);stroke-width:2px}._2SxacG_pearlShellFront{fill:var(--dsw-alias-state-warn-secondary);opacity:.8}._2SxacG_pearl{fill:var(--dsw-alias-label-primary-inverted);stroke:var(--dsw-alias-state-business-primary);stroke-width:2px}._2SxacG_fishBody{fill:var(--dsw-alias-state-business-primary);opacity:.76}._2SxacG_fishTail{fill:var(--dsw-alias-state-business-primary);opacity:.52}._2SxacG_crabBody{fill:var(--dsw-alias-state-error-secondary);opacity:.78}._2SxacG_crabLine{fill:none;stroke:var(--dsw-alias-state-error-secondary);stroke-width:3px;stroke-linecap:round}._2SxacG_urchinSpines{fill:var(--dsw-alias-label-secondary);opacity:.7}._2SxacG_urchinBody{fill:var(--dsw-alias-label-tertiary)}._2SxacG_jellyCap{fill:var(--dsw-alias-state-error-primary);opacity:.72}._2SxacG_objectLine{fill:none;stroke:var(--dsw-alias-label-secondary);stroke-width:3px;stroke-linecap:round}._2SxacG_coral{fill:none;stroke:var(--dsw-alias-state-error-secondary);stroke-width:8px;stroke-linecap:round;stroke-linejoin:round}._2SxacG_shell{fill:var(--dsw-alias-state-warn-secondary);opacity:.78}._2SxacG_touchControls{z-index:9;justify-content:center;gap:8px;display:flex;position:absolute;bottom:3px;left:0;right:0}._2SxacG_touchControls button{background:var(--dsw-alias-button-floating-fill);cursor:pointer;border:0;border-radius:10px;width:62px;height:30px}._2SxacG_runnerBoard{background:var(--dsw-alias-bg-layer-2)}._2SxacG_runnerCanvas{width:100%;height:100%;display:block}._2SxacG_splash{z-index:12;pointer-events:none;width:2px;height:2px;position:absolute}._2SxacG_splash i{background:var(--dsw-alias-state-business-primary);border-radius:50%;width:7px;height:11px;animation:.55s ease-out forwards _2SxacG_splash;position:absolute}._2SxacG_splash i:first-child{--splash-x:-27px;--splash-y:-25px}._2SxacG_splash i:nth-child(2){--splash-x:-11px;--splash-y:-36px;animation-delay:40ms}._2SxacG_splash i:nth-child(3){--splash-x:13px;--splash-y:-34px;animation-delay:20ms}._2SxacG_splash i:nth-child(4){--splash-x:29px;--splash-y:-20px}._2SxacG_scores{margin-top:14px}._2SxacG_scores h3{font:var(--dsw-font-s-strong-14);margin:0 0 8px}._2SxacG_scores ol{margin:0;padding:0;list-style:none}._2SxacG_scores li{border-radius:7px;grid-template-columns:36px 1fr auto;gap:8px;padding:5px 8px;display:grid}._2SxacG_scores li:nth-child(odd){background:var(--dsw-alias-interactive-bg-hover)}._2SxacG_scores time,._2SxacG_empty{color:var(--dsw-alias-label-secondary)}._2SxacG_empty{margin:0}@keyframes _2SxacG_bubbles{0%{transform:translateY(0)scale(.7)}to{opacity:0;transform:translateY(-230px)scale(1.15)}}@keyframes _2SxacG_splash{to{transform:translate(var(--splash-x), var(--splash-y)) scale(.25);opacity:0}}@keyframes _2SxacG_whaleFloat{0%,to{translate:0}50%{translate:0 -5px}}@media (width<=560px){._2SxacG_root{bottom:12px;right:12px}._2SxacG_catalog{grid-template-columns:1fr}._2SxacG_catalog>button{text-align:left;grid-template-columns:60px 1fr auto;display:grid}._2SxacG_catalog small{min-height:0}._2SxacG_hint{display:none}._2SxacG_gameBar{gap:7px}}@media (prefers-reduced-motion:reduce){._2SxacG_launcher,._2SxacG_oceanWaves i,._2SxacG_skyBubbles i,._2SxacG_splash i{transition:none;animation:none}}";
		...
		var WhaleArcade_module_css_default = {
			"scores": "_2SxacG_scores",
			"panel": "_2SxacG_panel",
			"itemValue": "_2SxacG_itemValue",
			"catalog": "_2SxacG_catalog",
			"root": "_2SxacG_root",
			"whaleBelly": "_2SxacG_whaleBelly",
			"catalogIcon": "_2SxacG_catalogIcon",
			"runnerWhale": "_2SxacG_runnerWhale",
			"jumpingWhale": "_2SxacG_jumpingWhale",
			"obstacle": "_2SxacG_obstacle",
			"runnerBoard": "_2SxacG_runnerBoard",
			"pearlShellFront": "_2SxacG_pearlShellFront",
			"game": "_2SxacG_game",
			"coral": "_2SxacG_coral",
			"whaleFloat": "_2SxacG_whaleFloat",
			"shell": "_2SxacG_shell",
			"pearl": "_2SxacG_pearl",
			"closeButton": "_2SxacG_closeButton",
			"whaleTail": "_2SxacG_whaleTail",
			"iconButton": "_2SxacG_iconButton",
			"hint": "_2SxacG_hint",
			"skyBubbles": "_2SxacG_skyBubbles",
			"star": "_2SxacG_star",
			"launcher": "_2SxacG_launcher",
			"catcher": "_2SxacG_catcher",
			"fishTail": "_2SxacG_fishTail",
			"objectLine": "_2SxacG_objectLine",
			"runnerCanvas": "_2SxacG_runnerCanvas",
			"gameBar": "_2SxacG_gameBar",
			"gameTitle": "_2SxacG_gameTitle",
			"miniWave": "_2SxacG_miniWave",
			"bubbles": "_2SxacG_bubbles",
			"whaleEye": "_2SxacG_whaleEye",
			"splash": "_2SxacG_splash",
			"oceanBoard": "_2SxacG_oceanBoard",
			"objectDot": "_2SxacG_objectDot",
			"fishBody": "_2SxacG_fishBody",
			"whaleSmile": "_2SxacG_whaleSmile",
			"rockGate": "_2SxacG_rockGate",
			"oceanWaves": "_2SxacG_oceanWaves",
			"urchinSpines": "_2SxacG_urchinSpines",
			"empty": "_2SxacG_empty",
			"touchControls": "_2SxacG_touchControls",
			"whaleBody": "_2SxacG_whaleBody",
			"pearlShellBack": "_2SxacG_pearlShellBack",
			"crabLine": "_2SxacG_crabLine",
			"jellyCap": "_2SxacG_jellyCap",
			"falling": "_2SxacG_falling",
			"urchinBody": "_2SxacG_urchinBody",
			"backButton": "_2SxacG_backButton",
			"crabBody": "_2SxacG_crabBody",
			"gameOverlay": "_2SxacG_gameOverlay",
			"gameWhale": "_2SxacG_gameWhale",
			"whaleSpout": "_2SxacG_whaleSpout",
			"lightRays": "_2SxacG_lightRays"
		};
		//#endregion
		//#region lib/types/client/WhaleArcade.js
		...
		function OceanIcon({ kind }) {
			if (kind === "jelly") return (0, react_jsx_runtime.jsxs)("svg", {
				viewBox: "0 0 48 56",
				"aria-hidden": "true",
			...
			if (kind === "coral") return (0, react_jsx_runtime.jsx)("svg", {
				viewBox: "0 0 48 60",
				"aria-hidden": "true",
				children: (0, react_jsx_runtime.jsx)("path", {
			...
			if (kind === "shell") return (0, react_jsx_runtime.jsxs)("svg", {
				viewBox: "0 0 52 45",
				"aria-hidden": "true",
				children: [(0, react_jsx_runtime.jsx)("path", {
			...
			if (kind === "fish") return (0, react_jsx_runtime.jsxs)("svg", {
				viewBox: "0 0 56 38",
				"aria-hidden": "true",
				children: [
					(0, react_jsx_runtime.jsx)("path", {
			...
			if (kind === "crab") return (0, react_jsx_runtime.jsxs)("svg", {
				viewBox: "0 0 56 44",
				"aria-hidden": "true",
				children: [
					(0, react_jsx_runtime.jsx)("path", {
			...
			if (kind === "urchin") return (0, react_jsx_runtime.jsxs)("svg", {
				viewBox: "0 0 48 48",
				"aria-hidden": "true",
				children: [(0, react_jsx_runtime.jsx)("path", {
			...
			if (kind === "star") return (0, react_jsx_runtime.jsxs)("svg", {
				viewBox: "0 0 50 50",
				"aria-hidden": "true",
				children: [
					(0, react_jsx_runtime.jsx)("path", {
		...
		function Splash({ splash }) {
			return splash && (0, react_jsx_runtime.jsxs)("span", {
		...
		function CatalogIcon({ kind }) {
			return (0, react_jsx_runtime.jsx)("span", {
				...
				children: kind === "wave" ? (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [(0, react_jsx_runtime.jsx)(WhaleMark, {}), (0, react_jsx_runtime.jsx)("i", { className: WhaleArcade_module_css_default.miniWave })] }) : (0, react_jsx_runtime.jsx)(OceanIcon, { kind })
			});
		}
		function GameChrome({ game, phase, score, startedAt, onPhase, onScore, onBack, onClose, renderGame, t }) {
			...
			return (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					(0, react_jsx_runtime.jsxs)("div", {
						...
						children: [
							...
							(0, react_jsx_runtime.jsxs)("span", { children: [
								t("score"),
								" ",
								(0, react_jsx_runtime.jsx)("strong", { children: String(score).padStart(5, "0") })
							] }),
							(0, react_jsx_runtime.jsxs)("span", { children: [
								t("best"),
								" ",
								(0, react_jsx_runtime.jsx)("strong", { children: String(readScores(game)[0]?.score ?? 0).padStart(5, "0") })
							] }),
							(0, react_jsx_runtime.jsx)("button", {
								type: "button",
								onClick: () => {
					...
					renderGame(finish),
					(phase === "ready" || phase === "over") && (0, react_jsx_runtime.jsxs)("div", {
						className: WhaleArcade_module_css_default.gameOverlay,
						children: [(0, react_jsx_runtime.jsx)("span", { children: phase === "over" ? t("over") : t(GAME_COPY[game].desc) }), (0, react_jsx_runtime.jsx)("button", {
							type: "button",
							onClick: () => {
								onScore(0);
								onPhase("playing");
			...
			return (0, react_jsx_runtime.jsxs)("button", {
				...
				children: [
					...
					(0, react_jsx_runtime.jsx)("span", {
						...
						style: { top: `${whale.y}%` },
						children: (0, react_jsx_runtime.jsx)(WhaleMark, { jumping: whale.velocity < 0 })
					}),
					rocks.map((rock) => (0, react_jsx_runtime.jsxs)("span", {
						className: WhaleArcade_module_css_default.rockGate,
						style: { left: `${rock.x}%` },
						children: [(0, react_jsx_runtime.jsx)("i", { style: { height: `${rock.gap - rock.opening / 2}%` } }), (0, react_jsx_runtime.jsx)("i", { style: { top: `${rock.gap + rock.opening / 2}%` } })]
					}, rock.id)),
					(0, react_jsx_runtime.jsxs)("div", {
						className: WhaleArcade_module_css_default.oceanWaves,
						children: [(0, react_jsx_runtime.jsx)("i", {}), (0, react_jsx_runtime.jsx)("i", {})]
					}),
					(0, react_jsx_runtime.jsx)(Splash, { splash })
				]
			});
		}
		function CatchGame({ phase, round, score, onScore, finish }) {
			...
			return (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					(0, react_jsx_runtime.jsx)("div", { className: WhaleArcade_module_css_default.lightRays }),
					(0, react_jsx_runtime.jsxs)("div", {
						className: WhaleArcade_module_css_default.skyBubbles,
						children: [
							(0, react_jsx_runtime.jsx)("i", {}),
					...
					items.map((item) => (0, react_jsx_runtime.jsxs)("span", {
						...
						children: [(0, react_jsx_runtime.jsx)(OceanIcon, { kind: item.kind }), (0, react_jsx_runtime.jsx)("b", {
					...
					(0, react_jsx_runtime.jsx)("span", {
						...
						style: { left: `${whaleX}%` },
						children: (0, react_jsx_runtime.jsx)(WhaleMark, {})
					}),
					(0, react_jsx_runtime.jsxs)("div", {
						className: WhaleArcade_module_css_default.oceanWaves,
						children: [(0, react_jsx_runtime.jsx)("i", {}), (0, react_jsx_runtime.jsx)("i", {})]
		...
		function RunnerGame({ phase, round, score, onScore, finish }) {
			...
			return (0, react_jsx_runtime.jsx)("button", {
				...
				children: (0, react_jsx_runtime.jsx)(RunnerScene, {
					whaleY: whale.y,
					obstacles,
					splash
				})
		...
		function WhaleArcade({ t }) {
			...
			const startedAt = (0, react.useRef)(Date.now());
			const select = (id) => {
				setGame(id);
				setPhase("ready");
				setScore(0);
			...
			(0, react.useEffect)(() => {
				const hidden = () => {
					if (document.hidden) setPhase((value) => value === "playing" ? "paused" : value);
				};
			...
			const gameBody = (0, react.useMemo)(() => (finish) => {
				if (game === "jump") return (0, react_jsx_runtime.jsx)(JumpGame, {
					phase,
					round,
					score,
					onScore: setScore,
				...
				if (game === "catch") return (0, react_jsx_runtime.jsx)(CatchGame, {
					phase,
					round,
					score,
					onScore: setScore,
				...
				if (game === "runner") return (0, react_jsx_runtime.jsx)(RunnerGame, {
					phase,
					round,
					score,
					onScore: setScore,
			...
			return (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [open && (0, react_jsx_runtime.jsxs)("div", {
					...
					role: "dialog",
					"aria-label": t("title"),
					children: [game === null && (0, react_jsx_runtime.jsxs)("header", { children: [(0, react_jsx_runtime.jsxs)("div", { children: [(0, react_jsx_runtime.jsx)("h2", { children: t("title") }), (0, react_jsx_runtime.jsx)("p", { children: t("subtitle") })] }), (0, react_jsx_runtime.jsx)("button", {
						type: "button",
						className: WhaleArcade_module_css_default.iconButton,
						onClick: close,
						"aria-label": t("close"),
						children: "×"
					})] }), game === null ? (0, react_jsx_runtime.jsx)("div", {
						className: WhaleArcade_module_css_default.catalog,
						children: Object.keys(GAME_COPY).map((id) => (0, react_jsx_runtime.jsxs)("button", {
							type: "button",
							onClick: () => {
								select(id);
							},
							children: [
								(0, react_jsx_runtime.jsx)(CatalogIcon, { kind: GAME_COPY[id].icon }),
								(0, react_jsx_runtime.jsx)("strong", { children: t(GAME_COPY[id].name) }),
								(0, react_jsx_runtime.jsx)("small", { children: t(GAME_COPY[id].desc) }),
					...
					}) : (0, react_jsx_runtime.jsx)(GameChrome, {
						game,
						phase,
						score,
